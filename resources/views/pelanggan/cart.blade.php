            ...
            <div class="check-page-top-content">
                <div class="checkout-page-top-sec">
                    <div class="checkout-page-top-sec-img">
                        <img src="/foto_produk/{{$item['attributes']['foto']}}" alt="chair-img" class="img-fluid">
                    </div>
                    <div class="checkout-quantity-sec">
                        <p class="chek-txt1">{{$item['attributes']['kategori']}}</p>
                        <h4 class="chek-txt2 mt-16">{{$item['name']}}</h4>
                        <h5 class="chek-txt3 mt-8">Qty: {{$item['quantity']}} x Rp. {{$item['price'] / $item['quantity']}}</h5>
                    </div>
                    <div class="checkoutpage-increment-full">
                        <div class="checkoutpage-increment-full-details">
                            <p class="chek-txt4">Rp. {{number_format($item['price'])}}</p>
                            <div class="quantity">
                                <a href="{{url('/keranjang/hapus/'. $item['id'])}}">
                                    Hapus
                                </a>
                            </div>
                        </div>
                ...
                <div class="checkoutpage-price-sec-full">
                    ...
                    <div class="check-page-bottom mt-12">
                        ...
                        <div class="check-page-bottom-deatails mt-12">
                            ...
                            <div>
                                <p class="col-black">Rp. {{number_format(\Cart::getTotal())}}</p>
                            </div>
                        </div>
                    </div>
                </div>
