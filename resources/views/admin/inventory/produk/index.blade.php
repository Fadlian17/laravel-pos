                            ...
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('produk_edit', $produks->id)}}"><i class="fa fa-edit" aria-hidden="true" title="Edit"></i></a>
                                            <a href="{{route('produk_hapus', $produks->id)}}" class="confirmation"><i class="fa fa-trash-o" aria-hidden="true" title="Hapus"></i></a>
                                        </td>
