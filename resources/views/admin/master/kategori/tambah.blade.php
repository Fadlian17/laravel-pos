                ...
                <div class="card forms-card">
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{route('kategori_proses_tambah')}}" method="POST"  enctype="multipart/form-data">>
                            	@csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="foto_kategori" class="form-control" placeholder="Foto Produk">
                                </div>
