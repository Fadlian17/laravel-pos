                ...
                <div class="card forms-card">
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{route('kasir_profile_edit')}}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label class="text-label">Nama*</label>
                                    <input type="text" name="name" class="form-control" placeholder="Fadlian Alfansyah" required value="{{$profile->name}}">
                                </div>
                                <div class="form-group">
