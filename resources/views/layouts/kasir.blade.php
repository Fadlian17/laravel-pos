    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo"><a href="{{route('kasir')}}"><b><img src="/gleek/gleek/assets/images/logo.png" alt=""> </b><span class="brand-title"><img src="/gleek/gleek/assets/images/logo-text.png" alt=""></span></a>
            </div>
                    ...
                    <ul>
                        ...
                        <li class="icons">
                            ...
                            <div class="drop-down dropdown-profile animated bounceInDown">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li><a href="{{route('kasir_profile')}}"><i class="icon-user"></i> <span>My Profile</span></a>
                                        </li>
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-lg">
                        <a href="{{route('kasir')}}" aria-expanded="false">
                            <i class="mdi mdi-view-dashboard"></i><span class="nav-text">Dashboard</span>
                        </a>
                    </li>
                    <li class="nav-label">Fitur</li>
                    <li class="mega-menu mega-menu-md"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">Transaksi </span> </a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('transaksi')}}">Detail</a>
                            </li>
                        </ul>
                    </li>
                    <li class="mega-menu mega-menu-md"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">Transaksi Dev</span> </a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('prosestransaksi')}}">Detail</a></li>
                            <li><a href="{{route('aturjadwalkirim')}}">Atur Jadwal Pengiriman</a></li>
                        </ul>
                    </li>
