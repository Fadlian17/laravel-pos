    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo"><a href="{{route('admin')}}"><b><img src="/gleek/gleek/assets/images/logo.png" alt="" width="50"> </b><span class="brand-title"><img src="/gleek/gleek/assets/images/logo-text.png" alt="" width="50"></span></a>
            </div>
                    ...
                    <ul>
                        ...
                        <li class="icons">
                            ...
                            <div class="drop-down dropdown-profile animated bounceInDown">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li><a href="{{route('admin_profile')}}"><i class="icon-user"></i> <span>My Profile</span></a>
                                        </li>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-md"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">Master </span> </a>
                    ...
                    <li class="mega-menu mega-menu-md"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">Inventory </span> </a>
                        <ul aria-expanded="false">
                    ...
                    <li class="mega-menu mega-menu-md"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="nav-text">Laporan </span> </a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('laporan_produk')}}" target="_blank">Produk</a>
                            </li>
                            <li><a href="{{route('laporan_transaksi')}}" target="_blank">Transaksi</a>
                            </li>
                            <li><a href="{{route('laporan_produk_kosong')}}" target="_blank">Produk Kosong</a>
                            </li>
                        </ul>
                    </li>
                </ul>
